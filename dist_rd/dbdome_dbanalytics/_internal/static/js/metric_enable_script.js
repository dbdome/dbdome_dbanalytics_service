document.addEventListener('DOMContentLoaded', function() {
    ...
    // Confetti colors - brighter and more vibrant
    const colors = ['white', '#87CEEB', '#C0C0C0']; // white, light-blue, silver
    ...
    function animateConfetti() {
        ...
        for (let i = particles.length - 1; i >= 0; i--) {
            ...
            // Draw particle with enhanced brightness and glow effect
            ctx.save();
            ctx.globalAlpha = particle.life;
            ctx.translate(particle.x, particle.y);
            ctx.rotate(particle.rotation);
            
            // Add glow effect for brighter sparkles
            ctx.shadowBlur = 10;
            ...
            // Add center dot for extra brightness
            ctx.beginPath();
    ...
    function burstConfetti(buttonX, buttonY) {
        ...
        particles = [];
        // Increased particle count for more abundance
